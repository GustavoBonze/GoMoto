...
const mockDespesas: Despesa[] = [
  { id: '146', veiculo: 'DDD3D33', data: '2026-03-09', tipo_despesa: 'Preventiva', valor: 12.50, pagador: 'Caixa da Empresa', quilometragem: 29282, observacao: 'Troca de óleo, valor da nota 25,00', created_at: '2026-03-09T10:00:00Z' },
  { id: '145', veiculo: 'DDD3D33', data: '2026-02-27', tipo_despesa: 'Preventiva', valor: 45.75, pagador: 'Caixa da Empresa', quilometragem: 27058, observacao: 'Kit relação. Valor da nota 91,50', created_at: '2026-02-27T10:00:00Z' },
  { id: '144', veiculo: 'AAA0A00', data: '2026-02-27', tipo_despesa: 'Corretiva', valor: 100.00, pagador: 'Caixa da Empresa', observacao: 'Pneu dianteiro + mão de obra mecânico', created_at: '2026-02-27T10:00:00Z' },
  { id: '143', veiculo: 'AAA0A00', data: '2026-02-25', tipo_despesa: 'Corretiva', valor: 115.00, pagador: 'Caixa da Empresa', observacao: '65,00 guidão novo + 50,00 mão de obra mecânico', created_at: '2026-02-25T10:00:00Z' },
  { id: '142', veiculo: 'DDD3D33', data: '2026-02-24', tipo_despesa: 'Troca de óleo', valor: 14.45, pagador: 'Caixa da Empresa', quilometragem: 27058, observacao: 'Valor da nota 28,90', created_at: '2026-02-24T10:00:00Z' },
  { id: '141', veiculo: 'DDD3D33', data: '2026-02-20', tipo_despesa: 'Seguro', valor: 169.90, pagador: 'Caixa da Empresa', created_at: '2026-02-20T10:00:00Z' },
  { id: '140', veiculo: 'CCC2C22', data: '2026-02-20', tipo_despesa: 'Seguro', valor: 171.28, pagador: 'Caixa da Empresa', created_at: '2026-02-20T10:00:00Z' },
  { id: '139', veiculo: 'BBB1B11', data: '2026-02-20', tipo_despesa: 'Seguro', valor: 171.00, pagador: 'Caixa da Empresa', created_at: '2026-02-20T10:00:00Z' },
  { id: '138', veiculo: 'AAA0A00', data: '2026-02-20', tipo_despesa: 'Seguro', valor: 191.28, pagador: 'Caixa da Empresa', created_at: '2026-02-20T10:00:00Z' },
  { id: '137', veiculo: 'DDD3D33', data: '2026-02-13', tipo_despesa: 'Corretiva', valor: 20.00, pagador: 'Caixa da Empresa', observacao: 'Troca da lona de freio', created_at: '2026-02-13T10:00:00Z' },
  { id: '136', veiculo: 'DDD3D33', data: '2026-02-11', tipo_despesa: 'Corretiva', valor: 27.00, pagador: 'Caixa da Empresa', observacao: 'Lâmpada farol', created_at: '2026-02-11T10:00:00Z' },
  { id: '135', veiculo: 'AAA0A00', data: '2026-02-09', tipo_despesa: 'Corretiva', valor: 250.00, pagador: 'Caixa da Empresa', observacao: 'Roda traseira da Start 160', created_at: '2026-02-09T10:00:00Z' },
  { id: '131', veiculo: 'DDD3D33', data: '2026-01-21', tipo_despesa: 'Seguro', valor: 169.90, pagador: 'Caixa da Empresa', created_at: '2026-01-21T10:00:00Z' },
  { id: '130', veiculo: 'CCC2C22', data: '2026-01-21', tipo_despesa: 'Seguro', valor: 171.28, pagador: 'Caixa da Empresa', created_at: '2026-01-21T10:00:00Z' },
  { id: '129', veiculo: 'BBB1B11', data: '2026-01-21', tipo_despesa: 'Seguro', valor: 171.00, pagador: 'Caixa da Empresa', created_at: '2026-01-21T10:00:00Z' },
  { id: '128', veiculo: 'AAA0A00', data: '2026-01-21', tipo_despesa: 'Seguro', valor: 191.28, pagador: 'Caixa da Empresa', created_at: '2026-01-21T10:00:00Z' },
  { id: '126', veiculo: 'AAA0A00', data: '2026-01-15', tipo_despesa: 'Troca de óleo', valor: 17.00, pagador: 'Caixa da Empresa', quilometragem: 46578, observacao: 'Valor da nota 34,00', created_at: '2026-01-15T10:00:00Z' },
  { id: '125', veiculo: 'AAA0A00', data: '2026-01-02', tipo_despesa: 'Troca de óleo', valor: 17.00, pagador: 'Caixa da Empresa', quilometragem: 45525, observacao: 'Valor da nota 34,00', created_at: '2026-01-02T10:00:00Z' },
  { id: '124', veiculo: 'CCC2C22', data: '2026-01-06', tipo_despesa: 'Troca de óleo', valor: 15.00, pagador: 'Caixa da Empresa', quilometragem: 67908, observacao: 'Valor da nota 30,00', created_at: '2026-01-06T10:00:00Z' },
  { id: '103', veiculo: 'AAA0A00', data: '2025-10-31', tipo_despesa: 'Troca de óleo', valor: 17.00, pagador: 'Desconto na Semanal', quilometragem: 35572, observacao: 'Valor da nota 34,00', created_at: '2025-10-31T10:00:00Z' },
  { id: '86', veiculo: 'CCC2C22', data: '2025-09-10', tipo_despesa: 'Troca de óleo', valor: 15.00, pagador: 'Desconto na Semanal', quilometragem: 42503, observacao: 'Troca de óleo 30,00', created_at: '2025-09-10T10:00:00Z' },
  { id: '73', veiculo: 'AAA0A00', data: '2025-08-20', tipo_despesa: 'Pneu', valor: 124.50, pagador: 'Desconto na Semanal', quilometragem: 27999, observacao: 'Pneu novo', created_at: '2025-08-20T10:00:00Z' },
  { id: '57', veiculo: 'AAA0A00', data: '2025-08-10', tipo_despesa: 'Relação da moto', valor: 79.00, pagador: 'Desconto na Semanal', quilometragem: 23242, observacao: 'Relação R$ 65 (50%) - Parafuso R$ 14 (50%)', created_at: '2025-08-10T10:00:00Z' },
  { id: '43', veiculo: 'AAA0A00', data: '2025-07-15', tipo_despesa: 'Bateria', valor: 158.00, pagador: 'Desconto na Semanal', quilometragem: 16879, observacao: 'Bateria R$145 - Mão de obra R$10 - Parafuso R$3', created_at: '2025-07-15T10:00:00Z' },
  { id: '5', veiculo: 'AAA0A00', data: '2025-01-23', tipo_despesa: 'IPVA', valor: 270.40, pagador: 'Jamerson', created_at: '2025-01-23T10:00:00Z' },
  { id: '2', veiculo: 'BBB1B11', data: '2025-01-16', tipo_despesa: 'Compra da moto', valor: 10000.00, pagador: 'Gustavo', observacao: 'Adquirido do Sr. Juarez Ribeiro', created_at: '2025-01-16T10:00:00Z' },
  { id: '1', veiculo: 'AAA0A00', data: '2025-01-10', tipo_despesa: 'Compra da moto', valor: 13000.00, pagador: 'Jamerson', observacao: 'Adquirido do Bruno', created_at: '2025-01-10T10:00:00Z' },
]
