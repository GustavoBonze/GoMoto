...
const mockClientes: Cliente[] = [
  ...
  // ——— Ex-clientes ———
  {
    ...
    historico_locacao: [
      { data_inicio: '2024-06-01', data_fim: '2024-10-15', moto_placa: 'KYN9J41', moto_modelo: 'YAMAHA/YS150 FAZER SED', motivo_saida: 'Encerrou contrato com dívida em aberto.', valor_devido: 850 },
    ],
  ...
  },
  {
    ...
    historico_locacao: [
      { data_inicio: '2024-08-01', data_fim: '2025-01-20', moto_placa: 'SYF1C42', moto_modelo: 'HONDA/CG 160 START', motivo_saida: 'Abandonou a moto e sumiu com dívida em aberto.', valor_devido: 1200 },
    ],
