...
const mockMotosInit: MotoComKm[] = [
  { id: '1', placa: 'SYF1C42', modelo: 'Honda CG 160 START',       km_atual: 46578,
    contrato: { tipo: 'locacao',  cliente_nome: 'Cliente SYF1C42',  valor_semanal: 350, cobranca_proxima: '2026-03-21' } },
  { id: '2', placa: 'KYN9J41', modelo: 'Yamaha YS150 FAZER SED',   km_atual: 30987,
    contrato: { tipo: 'locacao',  cliente_nome: 'Cliente KYN9J41',  valor_semanal: 350, cobranca_proxima: '2026-03-21' } },
  { id: '3', placa: 'RIW4J89', modelo: 'Yamaha YS150 FAZER SED',   km_atual: 67908,
    contrato: { tipo: 'locacao',  cliente_nome: 'Cliente RIW4J89',  valor_semanal: 350, cobranca_proxima: '2026-03-21' } },
  { id: '4', placa: 'RJA5J85', modelo: 'Yamaha YBR150 FACTOR SED', km_atual: 29282,
    contrato: { tipo: 'promessa', cliente_nome: 'Cliente RJA5J85',  valor_semanal: 400, cobranca_proxima: '2026-03-28' } },
]
...
const mockManutencoesInit: ManutencaoItem[] = [
  ...
  mkBase({ id: 's_r1', moto_id: '1', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 46578, km_realizado: 46578, data_realizada: '2026-01-15', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),
  mkBase({ id: 's1',   moto_id: '1', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 47578, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Filtro de óleo: próxima @ 48.578 (a cada 2 trocas de óleo)
  mkBase({ id: 's2',   moto_id: '1', item_padrao_id: 'ip2', descricao: 'Filtro de óleo', km_previsto: 48578, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Relação: trocada em 12/12/2025 @ ~41.000 km → próxima: 53.000
  mkBase({ id: 's_r2', moto_id: '1', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 41000, km_realizado: 41000, data_realizada: '2025-12-12', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),
  mkBase({ id: 's3',   moto_id: '1', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 53000, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Lona de freio traseira: última @ 14.832 → estimado próxima: 50.832
  mkBase({ id: 's4',   moto_id: '1', item_padrao_id: 'ip6', descricao: 'Lona de freio traseira', km_previsto: 50832, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Pastilha de freio dianteira: próxima @ 50.578
  mkBase({ id: 's5',   moto_id: '1', item_padrao_id: 'ip7', descricao: 'Pastilha de freio dianteira', km_previsto: 50578, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Pneu dianteiro: trocado em 27/02/2026 → próxima: 58.578
  mkBase({ id: 's_r3', moto_id: '1', item_padrao_id: 'ip8', descricao: 'Pneu dianteiro', km_previsto: 46578, km_realizado: 46578, data_realizada: '2026-02-27', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),
  mkBase({ id: 's6',   moto_id: '1', item_padrao_id: 'ip8', descricao: 'Pneu dianteiro', km_previsto: 58578, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Pneu traseiro: último @ 27.999 → estimado próxima: 51.999
  mkBase({ id: 's7',   moto_id: '1', item_padrao_id: 'ip9', descricao: 'Pneu traseiro', km_previsto: 51999, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Filtro de ar: próxima @ 49.000
  mkBase({ id: 's8',   moto_id: '1', item_padrao_id: 'ip10', descricao: 'Filtro de ar', km_previsto: 49000, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Velas de ignição: próxima @ 50.578
  mkBase({ id: 's9',   moto_id: '1', item_padrao_id: 'ip11', descricao: 'Velas de ignição', km_previsto: 50578, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Amortecedores: próxima @ 52.500 (primeira troca desde compra a ~2.500 km)
  mkBase({ id: 's10',  moto_id: '1', item_padrao_id: 'ip12', descricao: 'Amortecedores', km_previsto: 52500, moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'sv1',  moto_id: '1', item_padrao_id: 'ip13', tipo: 'vistoria', descricao: 'Vistoria mensal', data_agendada: '2026-04-13', moto_placa: 'SYF1C42', moto_modelo: 'Honda CG 160 START', moto_km_atual: 46578 }),
  ...
  mkBase({ id: 'k_r1', moto_id: '2', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 30987, km_realizado: 30987, data_realizada: '2025-09-10', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),
  mkBase({ id: 'k1',   moto_id: '2', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 31987, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Filtro de óleo: próxima @ 33.000
  mkBase({ id: 'k2',   moto_id: '2', item_padrao_id: 'ip2', descricao: 'Filtro de óleo', km_previsto: 33000, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Relação: trocada em 13/08/2025 @ ~23.000 km → próxima: 35.000
  mkBase({ id: 'k_r2', moto_id: '2', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 23000, km_realizado: 23000, data_realizada: '2025-08-13', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),
  mkBase({ id: 'k3',   moto_id: '2', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 35000, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Lona de freio traseira: próxima @ 35.700
  mkBase({ id: 'k4',   moto_id: '2', item_padrao_id: 'ip6', descricao: 'Lona de freio traseira', km_previsto: 35700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Pastilha de freio dianteira: próxima @ 33.700
  mkBase({ id: 'k5',   moto_id: '2', item_padrao_id: 'ip7', descricao: 'Pastilha de freio dianteira', km_previsto: 33700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Pneu dianteiro: próxima @ 37.700
  mkBase({ id: 'k6',   moto_id: '2', item_padrao_id: 'ip8', descricao: 'Pneu dianteiro', km_previsto: 37700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Pneu traseiro: próxima @ 33.700
  mkBase({ id: 'k7',   moto_id: '2', item_padrao_id: 'ip9', descricao: 'Pneu traseiro', km_previsto: 33700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Filtro de ar: próxima @ 36.700
  mkBase({ id: 'k8',   moto_id: '2', item_padrao_id: 'ip10', descricao: 'Filtro de ar', km_previsto: 36700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Velas de ignição: PRÓXIMA — faltam apenas 713 km (alerta: 1.000 km)
  mkBase({ id: 'k9',   moto_id: '2', item_padrao_id: 'ip11', descricao: 'Velas de ignição', km_previsto: 31700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Amortecedores: VENCIDA — due @ 26.700, atual 30.987 (+4.287 km atrasado)
  mkBase({ id: 'k10',  moto_id: '2', item_padrao_id: 'ip12', descricao: 'Amortecedores', km_previsto: 26700, moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'kv1',  moto_id: '2', item_padrao_id: 'ip13', tipo: 'vistoria', descricao: 'Vistoria mensal', data_agendada: '2026-04-13', moto_placa: 'KYN9J41', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 30987 }),
  ...
  mkBase({ id: 'r_r1', moto_id: '3', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 67908, km_realizado: 67908, data_realizada: '2026-01-06', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),
  mkBase({ id: 'r1',   moto_id: '3', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 68908, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Filtro de óleo: próxima @ 68.360 (faltam 452 km — quase no limite)
  mkBase({ id: 'r2',   moto_id: '3', item_padrao_id: 'ip2', descricao: 'Filtro de óleo', km_previsto: 68360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Relação: trocada em 26/11/2025 @ ~60.000 km → próxima: 72.000
  mkBase({ id: 'r_r2', moto_id: '3', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 60000, km_realizado: 60000, data_realizada: '2025-11-26', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),
  mkBase({ id: 'r3',   moto_id: '3', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 72000, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Lona de freio traseira: próxima @ 72.360
  mkBase({ id: 'r4',   moto_id: '3', item_padrao_id: 'ip6', descricao: 'Lona de freio traseira', km_previsto: 72360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Pastilha de freio dianteira: VENCIDA — due @ 55.500, atual 67.908 (+12.408 km atrasado)
  mkBase({ id: 'r5',   moto_id: '3', item_padrao_id: 'ip7', descricao: 'Pastilha de freio dianteira', km_previsto: 55500, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Pneu dianteiro: próxima @ 72.360
  mkBase({ id: 'r6',   moto_id: '3', item_padrao_id: 'ip8', descricao: 'Pneu dianteiro', km_previsto: 72360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Pneu traseiro: próxima @ 72.360
  mkBase({ id: 'r7',   moto_id: '3', item_padrao_id: 'ip9', descricao: 'Pneu traseiro', km_previsto: 72360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Filtro de ar: próxima @ 73.360
  mkBase({ id: 'r8',   moto_id: '3', item_padrao_id: 'ip10', descricao: 'Filtro de ar', km_previsto: 73360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Velas de ignição: próxima @ 74.360
  mkBase({ id: 'r9',   moto_id: '3', item_padrao_id: 'ip11', descricao: 'Velas de ignição', km_previsto: 74360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Amortecedores: VENCIDA — due @ 49.360, atual 67.908 (+18.548 km atrasado)
  mkBase({ id: 'r10',  moto_id: '3', item_padrao_id: 'ip12', descricao: 'Amortecedores', km_previsto: 49360, moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'rv1',  moto_id: '3', item_padrao_id: 'ip13', tipo: 'vistoria', descricao: 'Vistoria mensal', data_agendada: '2026-04-13', moto_placa: 'RIW4J89', moto_modelo: 'Yamaha YS150 FAZER SED', moto_km_atual: 67908 }),
  ...
  mkBase({ id: 'f_r1', moto_id: '4', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 29282, km_realizado: 29282, data_realizada: '2026-03-09', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),
  mkBase({ id: 'f1',   moto_id: '4', item_padrao_id: 'ip1', descricao: 'Troca de óleo', km_previsto: 30282, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Filtro de óleo: próxima @ 31.058
  mkBase({ id: 'f2',   moto_id: '4', item_padrao_id: 'ip2', descricao: 'Filtro de óleo', km_previsto: 31058, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Relação: trocada em 27/02/2026 @ 27.058 km → próxima: 39.058
  mkBase({ id: 'f_r2', moto_id: '4', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 27058, km_realizado: 27058, data_realizada: '2026-02-27', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),
  mkBase({ id: 'f3',   moto_id: '4', item_padrao_id: 'ip5', descricao: 'Troca da relação (corrente/coroa/pinhão)', km_previsto: 39058, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Lona de freio traseira: trocada em 13/02/2026 @ ~25.500 km → próxima: 37.500
  mkBase({ id: 'f_r3', moto_id: '4', item_padrao_id: 'ip6', descricao: 'Lona de freio traseira', km_previsto: 25500, km_realizado: 25500, data_realizada: '2026-02-13', realizada: true, oficina: 'Oficina do Careca', moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),
  mkBase({ id: 'f4',   moto_id: '4', item_padrao_id: 'ip6', descricao: 'Lona de freio traseira', km_previsto: 37500, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Pastilha de freio dianteira: próxima @ 35.750
  mkBase({ id: 'f5',   moto_id: '4', item_padrao_id: 'ip7', descricao: 'Pastilha de freio dianteira', km_previsto: 35750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Pneu dianteiro: próxima @ 31.750
  mkBase({ id: 'f6',   moto_id: '4', item_padrao_id: 'ip8', descricao: 'Pneu dianteiro', km_previsto: 31750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Pneu traseiro: próxima @ 35.750
  mkBase({ id: 'f7',   moto_id: '4', item_padrao_id: 'ip9', descricao: 'Pneu traseiro', km_previsto: 35750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Filtro de ar: próxima @ 33.750
  mkBase({ id: 'f8',   moto_id: '4', item_padrao_id: 'ip10', descricao: 'Filtro de ar', km_previsto: 33750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Velas de ignição: PRÓXIMA — faltam apenas 468 km (alerta: 1.000 km)
  mkBase({ id: 'f9',   moto_id: '4', item_padrao_id: 'ip11', descricao: 'Velas de ignição', km_previsto: 29750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Amortecedores: próxima @ 44.750 (comprada a ~19.750 km)
  mkBase({ id: 'f10',  moto_id: '4', item_padrao_id: 'ip12', descricao: 'Amortecedores', km_previsto: 44750, moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'fv1',  moto_id: '4', item_padrao_id: 'ip13', tipo: 'vistoria', descricao: 'Vistoria mensal', data_agendada: '2026-04-13', moto_placa: 'RJA5J85', moto_modelo: 'Yamaha YBR150 FACTOR SED', moto_km_atual: 29282 }),
]
