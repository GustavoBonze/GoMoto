...
const mockMotorcyclesInit: MotorcycleWithKm[] = [
  { id: '1', plate: 'AAA0A00', model: 'Honda CG 160 START',       current_km: 46578,
    contract: { type: 'locacao',  customer_name: 'Cliente AAA0A00',  weekly_value: 350, next_billing: '2026-03-21' } },
  { id: '2', plate: 'BBB1B11', model: 'Yamaha YS150 FAZER SED',   current_km: 30987,
    contract: { type: 'locacao',  customer_name: 'Cliente BBB1B11',  weekly_value: 350, next_billing: '2026-03-21' } },
  { id: '3', plate: 'CCC2C22', model: 'Yamaha YS150 FAZER SED',   current_km: 67908,
    contract: { type: 'locacao',  customer_name: 'Cliente CCC2C22',  weekly_value: 350, next_billing: '2026-03-21' } },
  { id: '4', plate: 'DDD3D33', model: 'Yamaha YBR150 FACTOR SED', current_km: 29282,
    contract: { type: 'promessa', customer_name: 'Cliente DDD3D33',  weekly_value: 400, next_billing: '2026-03-28' } },
]
...
const mockMaintenancesInit: MaintenanceRecord[] = [
  ...
  mkBase({ id: 's_r1', motorcycle_id: '1', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 46578, actual_km: 46578, completed_date: '2026-01-15', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),
  mkBase({ id: 's1',   motorcycle_id: '1', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 47578, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Filtro de óleo: próxima @ 48.578 (a cada 2 trocas de óleo)
  mkBase({ id: 's2',   motorcycle_id: '1', standard_item_id: 'ip2', description: 'Filtro de ar', predicted_km: 48578, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Relação: trocada em 12/12/2025 @ ~41.000 km → próxima: 53.000
  mkBase({ id: 's_r2', motorcycle_id: '1', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 41000, actual_km: 41000, completed_date: '2025-12-12', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),
  mkBase({ id: 's3',   motorcycle_id: '1', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 53000, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Lona de freio traseira: última @ 14.832 → estimado próxima: 50.832
  mkBase({ id: 's4',   motorcycle_id: '1', standard_item_id: 'ip6', description: 'Lona de freio traseira', predicted_km: 50832, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Pastilha de freio dianteira: próxima @ 50.578
  mkBase({ id: 's5',   motorcycle_id: '1', standard_item_id: 'ip7', description: 'Pastilha de freio dianteira', predicted_km: 50578, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Pneu dianteiro: trocado em 27/02/2026 → próxima: 58.578
  mkBase({ id: 's_r3', motorcycle_id: '1', standard_item_id: 'ip8', description: 'Pneu dianteiro', predicted_km: 46578, actual_km: 46578, completed_date: '2026-02-27', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),
  mkBase({ id: 's6',   motorcycle_id: '1', standard_item_id: 'ip8', description: 'Pneu dianteiro', predicted_km: 58578, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Pneu traseiro: último @ 27.999 → estimado próxima: 51.999
  mkBase({ id: 's7',   motorcycle_id: '1', standard_item_id: 'ip9', description: 'Pneu traseiro', predicted_km: 51999, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Filtro de ar: próxima @ 49.000
  mkBase({ id: 's8',   motorcycle_id: '1', standard_item_id: 'ip10', description: 'Filtro de ar', predicted_km: 49000, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Velas de ignição: próxima @ 50.578
  mkBase({ id: 's9',   motorcycle_id: '1', standard_item_id: 'ip11', description: 'Velas de ignição', predicted_km: 50578, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Amortecedores: próxima @ 52.500 (primeira troca desde compra a ~2.500 km)
  mkBase({ id: 's10',  motorcycle_id: '1', standard_item_id: 'ip12', description: 'Amortecedores', predicted_km: 52500, motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'sv1',  motorcycle_id: '1', standard_item_id: 'ip13', type: 'inspection', description: 'Vistoria mensal', scheduled_date: '2026-04-13', motorcycle_plate: 'AAA0A00', motorcycle_model: 'Honda CG 160 START', motorcycle_current_km: 46578 }),
  ...
  mkBase({ id: 'k_r1', motorcycle_id: '2', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 30987, actual_km: 30987, completed_date: '2025-09-10', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),
  mkBase({ id: 'k1',   motorcycle_id: '2', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 31987, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Filtro de óleo: próxima @ 33.000
  mkBase({ id: 'k2',   motorcycle_id: '2', standard_item_id: 'ip2', description: 'Filtro de ar', predicted_km: 33000, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Relação: trocada em 13/08/2025 @ ~23.000 km → próxima: 35.000
  mkBase({ id: 'k_r2', motorcycle_id: '2', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 23000, actual_km: 23000, completed_date: '2025-08-13', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),
  mkBase({ id: 'k3',   motorcycle_id: '2', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 35000, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Lona de freio traseira: próxima @ 35.700
  mkBase({ id: 'k4',   motorcycle_id: '2', standard_item_id: 'ip6', description: 'Lona de freio traseira', predicted_km: 35700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Pastilha de freio dianteira: próxima @ 33.700
  mkBase({ id: 'k5',   motorcycle_id: '2', standard_item_id: 'ip7', description: 'Pastilha de freio dianteira', predicted_km: 33700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Pneu dianteiro: próxima @ 37.700
  mkBase({ id: 'k6',   motorcycle_id: '2', standard_item_id: 'ip8', description: 'Pneu dianteiro', predicted_km: 37700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Pneu traseiro: próxima @ 33.700
  mkBase({ id: 'k7',   motorcycle_id: '2', standard_item_id: 'ip9', description: 'Pneu traseiro', predicted_km: 33700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Filtro de ar: próxima @ 36.700
  mkBase({ id: 'k8',   motorcycle_id: '2', standard_item_id: 'ip10', description: 'Filtro de ar', predicted_km: 36700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Velas de ignição: PRÓXIMA — faltam apenas 713 km (alerta: 1.000 km)
  mkBase({ id: 'k9',   motorcycle_id: '2', standard_item_id: 'ip11', description: 'Velas de ignição', predicted_km: 31700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Amortecedores: VENCIDA — due @ 26.700, atual 30.987 (+4.287 km atrasado)
  mkBase({ id: 'k10',  motorcycle_id: '2', standard_item_id: 'ip12', description: 'Amortecedores', predicted_km: 26700, motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'kv1',  motorcycle_id: '2', standard_item_id: 'ip13', type: 'inspection', description: 'Vistoria mensal', scheduled_date: '2026-04-13', motorcycle_plate: 'BBB1B11', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 30987 }),
  ...
  mkBase({ id: 'r_r1', motorcycle_id: '3', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 67908, actual_km: 67908, completed_date: '2026-01-06', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),
  mkBase({ id: 'r1',   motorcycle_id: '3', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 68908, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Filtro de óleo: próxima @ 68.360 (faltam 452 km — quase no limite)
  mkBase({ id: 'r2',   motorcycle_id: '3', standard_item_id: 'ip2', description: 'Filtro de ar', predicted_km: 68360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Relação: trocada em 26/11/2025 @ ~60.000 km → próxima: 72.000
  mkBase({ id: 'r_r2', motorcycle_id: '3', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 60000, actual_km: 60000, completed_date: '2025-11-26', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),
  mkBase({ id: 'r3',   motorcycle_id: '3', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 72000, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Lona de freio traseira: próxima @ 72.360
  mkBase({ id: 'r4',   motorcycle_id: '3', standard_item_id: 'ip6', description: 'Lona de freio traseira', predicted_km: 72360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Pastilha de freio dianteira: VENCIDA — due @ 55.500, atual 67.908 (+12.408 km atrasado)
  mkBase({ id: 'r5',   motorcycle_id: '3', standard_item_id: 'ip7', description: 'Pastilha de freio dianteira', predicted_km: 55500, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Pneu dianteiro: próxima @ 72.360
  mkBase({ id: 'r6',   motorcycle_id: '3', standard_item_id: 'ip8', description: 'Pneu dianteiro', predicted_km: 72360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Pneu traseiro: próxima @ 72.360
  mkBase({ id: 'r7',   motorcycle_id: '3', standard_item_id: 'ip9', description: 'Pneu traseiro', predicted_km: 72360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Filtro de ar: próxima @ 73.360
  mkBase({ id: 'r8',   motorcycle_id: '3', standard_item_id: 'ip10', description: 'Filtro de ar', predicted_km: 73360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Velas de ignição: próxima @ 74.360
  mkBase({ id: 'r9',   motorcycle_id: '3', standard_item_id: 'ip11', description: 'Velas de ignição', predicted_km: 74360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Amortecedores: VENCIDA — due @ 49.360, atual 67.908 (+18.548 km atrasado)
  mkBase({ id: 'r10',  motorcycle_id: '3', standard_item_id: 'ip12', description: 'Amortecedores', predicted_km: 49360, motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'rv1',  motorcycle_id: '3', standard_item_id: 'ip13', type: 'inspection', description: 'Vistoria mensal', scheduled_date: '2026-04-13', motorcycle_plate: 'CCC2C22', motorcycle_model: 'Yamaha YS150 FAZER SED', motorcycle_current_km: 67908 }),
  ...
  mkBase({ id: 'f_r1', motorcycle_id: '4', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 29282, actual_km: 29282, completed_date: '2026-03-09', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),
  mkBase({ id: 'f1',   motorcycle_id: '4', standard_item_id: 'ip1', description: 'Troca de óleo', predicted_km: 30282, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Filtro de óleo: próxima @ 31.058
  mkBase({ id: 'f2',   motorcycle_id: '4', standard_item_id: 'ip2', description: 'Filtro de ar', predicted_km: 31058, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Relação: trocada em 27/02/2026 @ 27.058 km → próxima: 39.058
  mkBase({ id: 'f_r2', motorcycle_id: '4', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 27058, actual_km: 27058, completed_date: '2026-02-27', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),
  mkBase({ id: 'f3',   motorcycle_id: '4', standard_item_id: 'ip5', description: 'Troca da relação (corrente/coroa/pinhão)', predicted_km: 39058, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Lona de freio traseira: trocada em 13/02/2026 @ ~25.500 km → próxima: 37.500
  mkBase({ id: 'f_r3', motorcycle_id: '4', standard_item_id: 'ip6', description: 'Lona de freio traseira', predicted_km: 25500, actual_km: 25500, completed_date: '2026-02-13', completed: true, workshop: 'Oficina do Careca', motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),
  mkBase({ id: 'f4',   motorcycle_id: '4', standard_item_id: 'ip6', description: 'Lona de freio traseira', predicted_km: 37500, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Pastilha de freio dianteira: próxima @ 35.750
  mkBase({ id: 'f5',   motorcycle_id: '4', standard_item_id: 'ip7', description: 'Pastilha de freio dianteira', predicted_km: 35750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Pneu dianteiro: próxima @ 31.750
  mkBase({ id: 'f6',   motorcycle_id: '4', standard_item_id: 'ip8', description: 'Pneu dianteiro', predicted_km: 31750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Pneu traseiro: próxima @ 35.750
  mkBase({ id: 'f7',   motorcycle_id: '4', standard_item_id: 'ip9', description: 'Pneu traseiro', predicted_km: 35750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Filtro de ar: próxima @ 33.750
  mkBase({ id: 'f8',   motorcycle_id: '4', standard_item_id: 'ip10', description: 'Filtro de ar', predicted_km: 33750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Velas de ignição: PRÓXIMA — faltam apenas 468 km (alerta: 1.000 km)
  mkBase({ id: 'f9',   motorcycle_id: '4', standard_item_id: 'ip11', description: 'Velas de ignição', predicted_km: 29750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Amortecedores: próxima @ 44.750 (comprada a ~19.750 km)
  mkBase({ id: 'f10',  motorcycle_id: '4', standard_item_id: 'ip12', description: 'Amortecedores', predicted_km: 44750, motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),

  // Vistoria mensal: próxima 13/04/2026
  mkBase({ id: 'fv1',  motorcycle_id: '4', standard_item_id: 'ip13', type: 'inspection', description: 'Vistoria mensal', scheduled_date: '2026-04-13', motorcycle_plate: 'DDD3D33', motorcycle_model: 'Yamaha YBR150 FACTOR SED', motorcycle_current_km: 29282 }),
]
